                    ...
                    <Grid container spacing={2} sx={{ mt: 1 }}>
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            <FormSelect
                                ...
                                onChange={handleChange}
                                options={bagAttributes["handle-color"]?.map((v) => ({ label: v, value: v })) || []}
                                required
                                className="text-sm"
                            />
                        </Grid>
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            <FormSelect
                                ...
                                onChange={handleChange}
                                options={bagAttributes["size"]?.map((v) => ({ label: v, value: v })) || []}
                                required
                                className="text-sm"
                            />
                        </Grid>
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            <FormSelect
                                ...
                                onChange={handleChange}
                                options={bagAttributes["bag-color"]?.map((v) => ({ label: v, value: v })) || []}
                                required
                                className="text-sm"
                            />
                        </Grid>
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            <FormSelect
                                ...
                                onChange={handleChange}
                                options={bagAttributes["gsm"]?.map((v) => ({ label: v, value: v })) || []}
                                required
                                className="text-sm"
                            />
                        </Grid>
                        <Grid item xs={12} md={6}>
                            ...
                            <FormSelect
                                ...
                                onChange={handleChange}
                                options={bagAttributes["fabric-quality"]?.map((v) => ({ label: v, value: v })) || []}
                                required
                                className="text-sm"
                            />
                        </Grid>
