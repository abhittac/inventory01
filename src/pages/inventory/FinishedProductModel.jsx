      ...
      <DialogContent>
        <Box sx={{ mt: 2 }}>
          ...
          <Card sx={{ mb: 3 }}>
            ...
            <CardContent>
              <Grid container spacing={2}>
                {productionData.unitNumbers &&
                  Object.entries(productionData.unitNumbers)
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <Typography variant="body1" fontWeight="bold">
                    {productionData.productionManagerDetails?.production_details
                      ?.progress || "N/A"}
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
            ...
            <CardContent>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <Typography variant="body1" fontWeight="bold">
                    {productionData.orderDetails?.bagDetails?.handleColor ||
                      "N/A"}
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
                ...
                {productionData.operatorCompleteDate &&
                  Object.entries(productionData.operatorCompleteDate)
                    ...
                    .map(([key, value]) => (
                      <Grid item xs={12} sm={6} key={key}>
                        <Typography variant="body2" color="text.secondary">
                          {key.charAt(0).toUpperCase() + key.slice(1)} Completed
                          Date
                        </Typography>
                        <Typography variant="body1" fontWeight="bold">
                    ...
                    label={
                      productionData.deliveryDetails?.status
                        ? productionData.deliveryDetails.status
                            .charAt(0)
                            .toUpperCase() +
                          productionData.deliveryDetails.status.slice(1)
                        : "Unknown"
                    }
